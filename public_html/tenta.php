    ...
    <body>
      ...
      <?php
          ...
          function pointsFunc($partOne, $partTwo, $partThree, $partFour){                 // define fuction and take  4 arguments 
           ...
           function total(){
             global $totalClass;                                            // access global array
              echo "<br> Det minsta värdet i klassen var " . min($totalClass);     // echo out the samllest number in the variable
              echo "<br> Det minsta värdet i klassen var " .max($totalClass);      // echo out the biggest number in the variable
